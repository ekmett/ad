...
-- >>> data V2 a = V2 a a   deriving (Generic1, Functor, Show)
-- >>> data V3 a = V3 a a a deriving (Generic1, Functor, Show)
-- >>> instance Representable V2; instance Distributive V2 where distribute = distributeRep
